...
def main() -> int:
    ...
    manifest = {
        ...
        "delivery": {"version": "delivery_02", "supersedes": "delivery_01", "trigger": "claude methods/_m4_20260912/codex/M4_02B_REVIEW_01.md",
                     "trigger_sha256": consumed["claude methods/_m4_20260912/codex/M4_02B_REVIEW_01.md"]["sha256"], "correction_matrix": f"{REL}/CORRECTION_MATRIX.md",
                     "superseded_delivery_01": {"path": f"{REL}/superseded/delivery_01/", "status_file_sha256": sha256(HERE / "superseded" / "delivery_01" / "DELIVERY_STATUS.json"),
                                                "risk_sha256": delivery_01["first_delivery_risk_sha256"], "tests_sha256": delivery_01["first_delivery_tests_sha256"],
                                                "manifest_sha256": delivery_01["first_delivery_manifest_sha256"], "files": len(delivery_01["files"])},
                     "codex_probe_replay": {"file": f"{REL}/evidence/codex_probe_risk_replay_01.json", "checks": replay["summary"]["checks"], "passed_now": replay["summary"]["passed_now"],
                                            "passed_on_first_delivery": replay["summary"]["passed_on_first_delivery"], "frozen_results_sha256": replay["frozen_results_sha256"],
                                            "adaptation": replay["adaptation"], "codex_files_modified": False}},
