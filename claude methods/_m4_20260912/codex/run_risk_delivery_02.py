...
OUT=Path(__file__).resolve().parent/'risk_review_02'
paths=[ROOT/'backend/app/research/m4_risk.py',ROOT/'backend/app/research/m4_execution.py',ROOT/'backend/app/research/m4_portfolio.py',ROOT/'backend/tests/test_m4_risk.py']
...
spec=importlib.util.spec_from_file_location('codex_portfolio_delivery_suite',paths[3])
