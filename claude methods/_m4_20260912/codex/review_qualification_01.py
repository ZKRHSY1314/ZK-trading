...
SRC=BASE/'claude_03a'
OUT=BASE/'codex/qualification_review_01'
...
for n in ['artifact_manifest.json','qualification.json','QUALIFICATION_MATRIX.md','NEXT_READ_PROPOSAL.md','validate_qualification.py']:
