...
assert not (OUT/'independent_mapping_checks_final.json').exists()
denials=[]
...
(OUT/'independent_mapping_checks_final.json').write_text(json.dumps(result,ensure_ascii=False,indent=2),encoding='utf-8')
