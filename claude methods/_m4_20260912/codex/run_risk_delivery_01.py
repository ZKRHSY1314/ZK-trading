...
OUT=Path(__file__).resolve().parent/'risk_review_01'
paths=[ROOT/'backend/app/research/m4_execution.py',ROOT/'backend/app/research/m4_portfolio.py',ROOT/'backend/tests/test_m4_risk.py']
