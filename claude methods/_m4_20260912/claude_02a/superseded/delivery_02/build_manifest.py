...
def main() -> int:
    ...
    manifest = {
        ...
        "delivery": {"version": "delivery_02", "supersedes": "delivery_01", "trigger": "claude methods/_m4_20260912/codex/M4_02A_REVIEW_01.md",
                     "trigger_sha256": consumed["claude methods/_m4_20260912/codex/M4_02A_REVIEW_01.md"]["sha256"], "correction_matrix": f"{REL}/CORRECTION_MATRIX.md",
                     ...
                     "codex_probe_replay": {"file": f"{REL}/evidence/codex_probe_portfolio_replay_01.json", "checks": replay["summary"]["checks"],
        ...
        "commands": [
            ...
            {"purpose": "codex probe replay (5 checks, verbatim fixtures)", "command": f"backend/.venv/Scripts/python.exe -B -X utf8 \"{REL}/replay_codex_probe_portfolio_01.py\"",
