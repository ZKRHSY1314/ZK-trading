...
* **Boundary reporting (G3-R2b):** endpoint_* flags compare only the two usable endpoint reference rows; interval_* flags and boundaries_crossed walk every reference row between them, inclusive, so a boundary that is crossed and returned from is still reported. Only reference rows carry source/updated_at: vendor-only and absent dates contribute no crossing and are never given fabricated metadata
...
**Consecutive-usable-date ratio changes:** 537 pairs — 70 zero, 467 nonzero; 3 cross a source/fetch-time boundary (interval-aware), of which 0 have equal endpoint metadata; 3 endpoint changes; 3 crossings in total; 0 pairs with skipped intervening dates; largest absolute change 0.05547850208 (a magnitude, not a threshold).

Pairs crossing a metadata boundary (interval-aware; a pair may cross one even when its two endpoint rows agree):

| from | to | change (unrounded) | crossings | crossing dates | interval source / fetch changed | endpoint source / fetch changed | skipped dates |
|---|---|---|---|---|---|---|---|
| 2024-08-12 | 2024-08-13 | -0.004911381593 | 1 | 2024-08-13 | True / True | True / True | 0 |
| 2026-07-23 | 2026-07-24 | +0 | 1 | 2026-07-24 | False / True | False / True | 0 |
| 2026-07-24 | 2026-07-27 | +0 | 1 | 2026-07-27 | True / True | True / True | 0 |
...
**Consecutive-usable-date ratio changes:** 537 pairs — 537 zero, 0 nonzero; 3 cross a source/fetch-time boundary (interval-aware), of which 0 have equal endpoint metadata; 3 endpoint changes; 3 crossings in total; 0 pairs with skipped intervening dates; largest absolute change 0 (a magnitude, not a threshold).

Pairs crossing a metadata boundary (interval-aware; a pair may cross one even when its two endpoint rows agree):

| from | to | change (unrounded) | crossings | crossing dates | interval source / fetch changed | endpoint source / fetch changed | skipped dates |
|---|---|---|---|---|---|---|---|
| 2024-06-20 | 2024-06-21 | +0 | 1 | 2024-06-21 | False / True | False / True | 0 |
| 2024-06-21 | 2024-06-24 | +0 | 1 | 2024-06-24 | False / True | False / True | 0 |
| 2026-06-09 | 2026-06-10 | +0 | 1 | 2026-06-10 | False / True | False / True | 0 |
...
**Consecutive-usable-date ratio changes:** 500 pairs — 79 zero, 421 nonzero; 2 cross a source/fetch-time boundary (interval-aware), of which 0 have equal endpoint metadata; 2 endpoint changes; 2 crossings in total; 0 pairs with skipped intervening dates; largest absolute change 0.01433605608 (a magnitude, not a threshold).

Pairs crossing a metadata boundary (interval-aware; a pair may cross one even when its two endpoint rows agree):

| from | to | change (unrounded) | crossings | crossing dates | interval source / fetch changed | endpoint source / fetch changed | skipped dates |
|---|---|---|---|---|---|---|---|
| 2026-07-23 | 2026-07-24 | +0 | 1 | 2026-07-24 | True / True | True / True | 0 |
| 2026-07-24 | 2026-07-27 | +0 | 1 | 2026-07-27 | True / True | True / True | 0 |
