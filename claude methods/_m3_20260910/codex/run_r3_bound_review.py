"""Run a statically reviewed M3-01-R3 bound-review stdlib test file with side effects restricted.
...
def main():
    ...
    allowed_targets = {ROOT / 'backend/tests/test_m3_labels.py', HERE / 'boundary_probe.py',
                       ...
                       HERE / 'test_independent_r2.py', HERE / 'test_independent_r3.py', HERE / 'test_independent_r3_bound.py'}
