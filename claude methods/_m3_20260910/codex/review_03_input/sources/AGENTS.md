...
Read `CODEX_CLAUDE_COLLABORATION.md` for the shared collaboration protocol. It defines handoffs and review ownership, but does not authorize automatic external-agent invocation or expand the safety boundaries below.
