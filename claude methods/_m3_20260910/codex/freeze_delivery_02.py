"""Pin a complete Claude M3-01-R2 delivery before independent execution.
...
def main():
    ...
    assert manifest['task_id'] == 'M3-01-R2-CONTRACT-FIX-20260910'
    ...
    assert all(key in written for key in (
        ...
        'claude methods/_m3_20260910/claude_01_r2/DELIVERY.md',
        'claude methods/_m3_20260910/claude_01_r2/LABEL_POLICY.md',
        'claude methods/_m3_20260910/claude_01_r2/LABEL_POLICY.json',
        'claude methods/_m3_20260910/claude_01_r2/test_output.txt'))
    blobs = {}
    pins = {}
    ...
    assert len(pins) == 13 and len(source_pins) == 16
    assert 'claude methods/_m3_20260910/claude_01_r2/REGRESSION_MAP.md' in written
