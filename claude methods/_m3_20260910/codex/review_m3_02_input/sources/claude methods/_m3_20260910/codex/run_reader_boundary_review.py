"""Run the statically reviewed M3-02 boundary test with no real SQLite with side effects restricted.

No SQLite, network or child processes. Writes are confined to a new Codex receipt
directory. This harness is for mocked boundary checks only, not the real M3-02 read.
"""
import contextlib
...
def main():
    ...
    allowed_targets = {HERE / 'test_independent_reader_boundary.py'}
    ...
    module = ROOT / 'backend/app/research/m3_frozen_reader.py'
