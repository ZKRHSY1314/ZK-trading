...
> Revision 3 — MD-R1 through MD-R3 of `M2_REMAINING_DEPENDENCY_CODEX_REVIEW.md`, then the
> three residual accuracy points of `..._CODEX_REVIEW_R2.md`, addressed in consolidated
> passes (§8); **reported as addressed pending Codex review, not marked closed here.**
>
