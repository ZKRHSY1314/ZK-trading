...
def plan():
    ...
    return {'kind':'remaining_pilot_residual_unissued','prior_failed_raw_sha256':'78fd5a3a4bb03c0e3bc243b2f9fb0f9e967ca427bdacedf679e7cf033e6850e9','max_attempts':32,'jobs':jobs[16:],
...
def capture(plan_sha):
    ...
    runtime=preflight()
    out=HERE/'remaining_capture_residual32';out.mkdir(exist_ok=False)
    ...
    for job in proposed['jobs']:
        ...
        if stop:break
    summary={'attempts':attempts,'unissued':32-attempts,'stop_reason':stop,'elapsed_seconds':time.monotonic()-start,
        'reused_instruments':20,'eligible':False,'live_trading':False,'database_access':False}
